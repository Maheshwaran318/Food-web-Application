...
%>
<form action="admin_update_ser" method="post">
<div class="container mt-3" >

 <table class="table table-striped">
 <tr>
<th>Enter pid to change</th><td><input type="text" name="pid"></td>
</tr>
<tr>
<th>Enter image to change</th><td><input type="text" name="img"></td>
</tr>
<tr>
<th>Enter Food Name to change</th><td><input type="text" name="fname"></td>
</tr>
<tr>
<th>Enter quantity to change</th><td><input type="text" name="qty"></td>
</tr>
<tr>
<th>Enter Price to change</th><td><input type="text" name="price"></td>
</tr>
