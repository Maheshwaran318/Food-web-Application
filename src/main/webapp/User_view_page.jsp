...
<div class="container mt-3" >
 ...
 <tr>
<th>Enter pid to Buy</th><td><input type="text" name="pid"></td>
</tr>
<tr>
<th>Enter quantity </th><td><input type="text" name="qty"></td>
</tr>
<tr>
<th><input type="submit" value="Continue"></th><td><a href="user_login.jsp"><input type="button" value="back"></a></td>
</tr>
